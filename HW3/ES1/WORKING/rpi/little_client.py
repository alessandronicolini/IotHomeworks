### MUST BE IN THE SAME FOLDER AS KWS SPLIT FILES AND LITTLE_MODEL.TFLITE ###
...
#device_name = scegliere ip raspberry
...
print("communication cost : " +str(weight/(1024*1024))+'MiB')
